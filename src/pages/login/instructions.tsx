    ...
    return (
        <div className='md:w-[50%] w-[100%] h-[80vh] md:h-screen  bg-dark-offset/40  flex round flex-col justify-center items-center'>
            ...
            <div className=' relative px-4 md:px-[1em] md:leading-loose'>
                <div className='bg-[#f9e69a] text-black leading-snug rounded font-medium px-[1.5em] py-[1.5em] mt-[3em] mb-3 '>
                    <h3> <i className="ri-file-warning-fill"></i> <b>Crucial Information:</b></h3>
                ...
                <ul className='flex flex-col justify-between gap-5 py-5'>
